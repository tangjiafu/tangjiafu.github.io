...
原文<https://www.jianshu.com/p/70dfd80e02ba>
...
![img](DistributionThory.assets/分布式理论-CAP.jpg)
...
![img](DistributionThory.assets/分布式理论-BASE.png)
...
![img](DistributionThory.assets/分布式事务两阶段提交-01.jpg)

提交阶段

如果事务在每个参与者上都执行成功，事务协调者发送通知让参与者提交事务；否则，协调者发送通知让参与者回滚事务。

![img](DistributionThory.assets/分布式事务两阶段提交-02.jpg)
...
![img](DistributionThory.assets/分布式事务本地消息.jpg)
...
![img](DistributionThory.assets/raft-candidate-01.gif)

- 此时 A 发送投票请求给其它所有节点。

![img](DistributionThory.assets/raft-candidate-02.gif)

- 其它节点会对请求进行回复，如果超过一半的节点回复了，那么该 Candidate 就会变成 Leader。

![img](DistributionThory.assets/raft-candidate-03.gif)

- 之后 Leader 会周期性地发送心跳包给 Follower，Follower 接收到心跳包，会重新开始计时。

![img](https://raw.githubusercontent.com/dunwu/JavaWeb/master/images/distributed/architecture/raft-candidate-04.gif)

#### 多个 Candidate 竞选

- 如果有多个 Follower 成为 Candidate，并且所获得票数相同，那么就需要重新开始投票，例如下图中 Candidate B 和 Candidate D 都获得两票，因此需要重新开始投票。

![img](DistributionThory.assets/raft-multi-candidate-01.gif)
...
![img](DistributionThory.assets/raft-sync-log-01.gif)
